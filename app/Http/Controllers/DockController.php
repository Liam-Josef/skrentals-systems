    ...
    public function returning() {
        ...
        return view('dock.returning', [
           'applications' => Website::where('id', '=', '1')->get(),
            ...
            'rentalReturnKayak' => Rental::where('activity_item', '=', ['Kayak Single', 'Double Kayak'])->where('activity_date', 'like', '%'.$today.'%')->orderByRaw("FIELD(status , 'On Dock', 'On Water', 'COC', 'Clear')")->orderBy('updated_at', 'asc')->get(),
            ...
            'rentalTypeKayak' => Rental::where('activity_item', '=', ['Kayak Single', 'Double Kayak'])->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', ['On Water', 'On Dock', 'COC', 'Clear'])->get()->count(),
            'rentalTypeSpyder' => Rental::where('activity_item', '=', 'Spyder RT-S SE6')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', ['On Water', 'On Dock', 'COC', 'Clear'])->get()->count(),
            'rentalTypeSegway' => Rental::where('activity_item', '=', 'Segway i2')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', ['On Water', 'On Dock', 'COC', 'Clear'])->get()->count(),
    ...
    public function departing() {
        ...
        return view('dock.departing', [
           'applications' => Website::where('id', '=', '1')->get(),
            ...
            'rentalDepartSeaDoo' => Rental::where('activity_item', '=', 'SeaDoo')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            ...
            'rentalDepartKayak' => Rental::where('activity_item', '=', ['Kayak Single', 'Double Kayak'])->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartSpyder' => Rental::where('activity_item', '=', 'Spyder RT-S SE6')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartSegway' => Rental::where('activity_item', '=', 'Segway i2')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartSkiDoo' => Rental::where('activity_item', '=', ['Renegade BC 600ETec', 'Summit 154 SP'])->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartRenegade' => Rental::where('activity_item', '=', 'Renegade BC 600ETec')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartSummit' => Rental::where('activity_item', '=', 'Summit 154 SP')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalDepartAluminum' => Rental::where('activity_item', '=', '14ft. Aluminum Boat')->where('activity_date', 'like', '%'.$today.'%')->orderBy('updated_at', 'asc')->get(),
            'rentalType' => Rental::where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get(),
            'rentalTypeScarab' => Rental::where('activity_item', '=', 'Scarab 215')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypePontoon' => Rental::where('activity_item', '=', '23ft. Pontoon Boat')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypeSeaDoo' => Rental::where('activity_item', '=', 'SeaDoo')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            ...
            'rentalTypeKayak' => Rental::where('activity_item', '=', ['Kayak Single', 'Double Kayak'])->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypeSpyder' => Rental::where('activity_item', '=', 'Spyder RT-S SE6')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypeSegway' => Rental::where('activity_item', '=', 'Segway i2')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypeSkiDoo' => Rental::where('activity_item', '=', ['Renegade BC 600ETec', 'Summit 154 SP'])->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'rentalTypeAluminum' => Rental::where('activity_item', '=', '14ft. Aluminum Boat')->select('activity_date')->where('activity_date', 'like', '%'.$today.'%')->where('status', '=', 'Checked In')->get()->count(),
            'posts' => Post::orderBy('created_at', 'desc')->take(1)->get(),
            'vehicles' => Vehicle::all(),
            'users' => $users,
            'vehicleScarab' => Vehicle::where('vehicle_type','=', 'Scarab')->where('location', '=', 'Dock')->where('launched', '=', '0')->get(),
