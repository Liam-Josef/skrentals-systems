<x-admin-master>
    ...
    @endsection
        ...
        @section('browser_title')
            <title>Permissions | {{$application->name}}</title>
        @endsection
                            ...
                            <table class="table table-bordered" id="permissionsTable" width="100%" cellspacing="0">
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="{{route('roles.permissions.edit', $permission->id)}}">
                                                @csrf
                                                @method('GET')
                                        ...
                                        <td>
                                            <form method="post" action="{{route('roles.permissions.delete', $permission->id)}}">
                                                @csrf
                                                @method('DELETE')
