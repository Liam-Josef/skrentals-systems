<x-admin-master>
    ...
    @endsection
        ...
        @section('page_title')
            <h1> @if($rental->invoice_number == '')
                    {{$rental->booking_id}}
                @else
                    #{{$rental->invoice_number}}
                @endif - {{$rental->first_name}} {{$rental->last_name}}</h1>
        @endsection
        ...
        @section('browser_title')
            <title>
                ...
                @else
                    #{{$rental->invoice_number}}
                @endif - {{$rental->first_name}} {{$rental->last_name}} | {{$application->name}}
            </title>
        @endsection
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="modal-footer pb-0">
                                        ...
                                        <a href="{{route('customers.profile.view', $rental_customer->id)}}" class="btn btn-primary">
                                            View Customer
                                        </a>
                                    </div>
                                </div>
