...
{{--                                                </div>--}}
        ...
        <div class="card mt-4 mb-5 shadow">
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#check_in{{$rental->id}}">CHECK IN</button>
        ...
        <div class="modal fade" id="check_in{{$rental->id}}" tabindex="-1" role="dialog" aria-labelledby="checkinModalLabel" aria-hidden="true">
