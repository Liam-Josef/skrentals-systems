...
<li class="nav-item {{ Request::is('admin/posts*') ? 'active' : '' }}">
    <a class="nav-link {{ Request::is(['admin/index*', 'admin/roles*', 'admin/rentals*', 'admin/users*', 'admin/maintenance*', 'admin/coc*', 'admin/customers*', 'admin/training*', 'admin/dev*']) ? 'collapsed' : '' }} " href="#" data-toggle="collapse" data-target="#collapseAnnouncements" aria-expanded="true" aria-controls="collapseAnnouncements">
...
@if(auth()->user()->userHasRole('Admin'))
    ...
    <li class="nav-item {{ Request::is('admin/users*') ? 'active' : '' }}">
        <a class="nav-link {{ Request::is(['admin/index*', 'admin/roles*', 'admin/rentals*', 'admin/posts*', 'admin/maintenance*', 'admin/coc*', 'admin/customers*', 'admin/training*', 'admin/vehicles*', 'admin/dev*']) ? 'collapsed' : '' }}" href="#" data-toggle="collapse" data-target="#collapseEmployees" aria-expanded="true" aria-controls="collapseEmployees">
...
@if(auth()->user()->userHasRole('Admin'))
    ...
    <li class="nav-item {{ Request::is('admin/training*') ? 'active' : '' }}">
        <a class="nav-link {{ Request::is(['admin/index*', 'admin/roles*', 'admin/rentals*', 'admin/posts*', 'admin/maintenance*', 'admin/coc*', 'admin/customers*', 'admin/users*', 'admin/vehicles*', 'admin/dev*']) ? 'collapsed' : '' }}" href="#" data-toggle="collapse" data-target="#collapseTraining" aria-expanded="true" aria-controls="collapseTraining">
            {{--            <i class="fas fa-fw fa-wrench"></i>--}}
