...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->stopSection(); ?>
        ...
        <?php $__env->startSection('browser_title'); ?>
            <title>Roles | <?php echo e($application->name); ?></title>
        <?php $__env->stopSection(); ?>
                    ...
                    <div class="card-header py-3 text-center">
                        <h6 class="m-0 font-weight-bold text-white">
                            ...
                            <?php if(session()->has('role-deleted')): ?>
                                <?php echo e(session('role-deleted')); ?>
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                       ...
                                       <td><?php echo e($role->slug); ?></td>
                                        <td>
                                            <form method="post" action="<?php echo e(route('roles.edit', $role->id)); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>