...
<li class="nav-item <?php echo e(Request::is('admin/maintenance*') ? 'active' : ''); ?>">
    <a class="nav-link <?php echo e(Request::is('admin/index*', ['admin/roles*', 'admin/rentals*', 'admin/users*', 'admin/posts*', 'admin/coc*', 'admin/customers*', 'admin/training*', 'admin/dev*', 'admin/vehicles*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseMaintenance" aria-expanded="true" aria-controls="collapseMaintenance">
    ...
    <div id="collapseMaintenance" class="collapse <?php echo e(Request::is('admin/maintenance*') ? 'show' : ''); ?>" aria-labelledby="headingMaintenance" data-parent="#accordionSidebar">
        <div class="py-2 collapse-inner rounded">
            ...
            <?php endif; ?>
            <a class="collapse-item <?php echo e(Request::is('admin/maintenance/hour-counts*') ? 'active' : ''); ?>" href="<?php echo e(route('maintenance.hours')); ?>">Hour Counts</a>
        </div>
    </div>
</li>
...
<?php if(auth()->user()->userHasRole('Admin')): ?>
    ...
    <li class="nav-item <?php echo e(Request::is('admin/vehicles*') ? 'active' : ''); ?>">
        <a class="nav-link <?php echo e(Request::is('admin/index*', ['admin/roles*', 'admin/rentals*', 'admin/posts*', 'admin/maintenance*', 'admin/coc*', 'admin/customers*', 'admin/dev*', 'admin/users*', 'admin/training*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseVehicles" aria-expanded="true" aria-controls="collapseVehicles">
        ...
        <div id="collapseVehicles" class="collapse <?php echo e(Request::is('admin/vehicles*') ? 'show' : ''); ?>" aria-labelledby="headingVehicles" data-parent="#accordionSidebar">
            <div class="py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?php echo e(Request::is('admin/vehicles/service*') ? 'active' : ''); ?>" href="<?php echo e(route('vehicle.service')); ?>">Move Vehicle</a>
                <a class="collapse-item" href="#" data-toggle="modal" data-target="#addVehicle">Add Vehicle</a>
            </div>
        </div>
    </li>
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/components/admin/sidebar/vehicles.blade.php ENDPATH**/ ?>