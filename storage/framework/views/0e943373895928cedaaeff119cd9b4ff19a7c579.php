<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-secondary fixed-top team-header">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(route('home.index')); ?>"><img src="<?php echo $__env->yieldContent('logo-horizontal-2'); ?>" alt="SK Watercraft Rentals" /></a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if(Auth::check()): ?>
                    <li class="nav-item smaller">
                        <a class="nav-link" href="<?php echo e(route('team.index')); ?>">Team Portal</a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH /var/www/rentalguru.systems/rg-website/resources/views/components/home/home-header.blade.php ENDPATH**/ ?>