...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('content-right'); ?>
        ...
        <div class="card format shadow mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('team.updateUser', $user->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/skrentals.systems/sk-website/resources/views/team/profile.blade.php ENDPATH**/ ?>