...
<li class="nav-item <?php echo e(Request::is('admin/rentals*') ? 'active' : ''); ?>">
    <a class="nav-link <?php echo e(Request::is(['admin/index*', 'admin/roles*', 'admin/maintenance*', 'admin/users*', 'admin/posts*', 'admin/coc*', 'admin/customers*', 'admin/training*', 'admin/vehicles*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseRentals" aria-expanded="true" aria-controls="collapseRentals">
    ...
    <div id="collapseRentals" class="collapse <?php echo e(Request::is('admin/rentals*') ? 'show' : ''); ?>" aria-labelledby="headingRentals" data-parent="#accordionSidebar">
        <div class="py-2 collapse-inner rounded">
            ...
            <a class="inactive collapse-item <?php echo e(Request::is('admin/rentals/index*') ? 'active' : ''); ?>" href="<?php echo e(route('rental.index')); ?>">Rentals Main</a>
            <a class="collapse-item <?php echo e(Request::is('admin/rentals/rentals-today*') ? 'active' : ''); ?>" href="<?php echo e(route('rental.today')); ?>">Rentals Today</a>
...
<li class="nav-item <?php echo e(Request::is('admin/coc*') ? 'active' : ''); ?>">
    <a class="nav-link visible-sm <?php echo e(Request::is(['admin/index*', 'admin/roles*', 'admin/maintenance*', 'admin/users*', 'admin/posts*', 'admin/rentals*', 'admin/customers*', 'admin/training*', 'admin/vehicles*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseCOC" aria-expanded="true" aria-controls="collapseCOC">
        <i class="fa-solid fa-person-drowning"></i>
        <span>COC</span>
    </a>
    <a class="nav-link visible-md <?php echo e(Request::is(['admin/index*', 'admin/roles*', 'admin/maintenance*', 'admin/users*', 'admin/posts*', 'admin/rentals*', 'admin/customers*', 'admin/training*', 'admin/vehicles*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseCOC" aria-expanded="true" aria-controls="collapseCOC">
        <i class="fa-solid fa-person-drowning"></i>
...
<li class="nav-item <?php echo e(Request::is('admin/customers*') ? 'active' : ''); ?>">
    <a class="nav-link <?php echo e(Request::is(['admin/index*', 'admin/roles*', 'admin/maintenance*', 'admin/users*', 'admin/posts*', 'admin/rentals*', 'admin/coc*', 'admin/training*', 'admin/vehicles*']) ? 'collapsed' : ''); ?>" href="#" data-toggle="collapse" data-target="#collapseCustomers" aria-expanded="true" aria-controls="collapseCustomers">
...
<?php /**PATH /var/www/rentalguru.systems/rg-website/resources/views/components/admin/sidebar/operations.blade.php ENDPATH**/ ?>