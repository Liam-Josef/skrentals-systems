            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-11">
                                <form action="<?php echo e(route('reschedule.update_date', $reschedule)); ?>" id="bookStage2" method="post">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field("PUT"); ?>
                                    <div class="form-group mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <h6 class="text-right"><?php echo e(Carbon\Carbon::parse($reschedule->activity_date_start)->format('D, M d, Y')); ?></h6>
                                            </div>
                                        </div>
                                        <input type="text" class="hidden" name="duration_id" value="0">
                                        <input type="text" class="form-control datepicker rentalDate" name="activity_date_start" id="datepicker" value="<?php echo e($reschedule->activity_date_start); ?>" placeholder="Select Date">
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $durations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $duration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($type->durations->contains($duration)): ?>
                                    ...
                                    <div class="col-sm-4">
                                        <form action="<?php echo e(route('reschedule.add_duration', $reschedule)); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            ...
                                            <?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($price->type_id == $reschedule->type_id && $price->duration_id == $duration->id): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/office/reschedule-2-duration.blade.php ENDPATH**/ ?>