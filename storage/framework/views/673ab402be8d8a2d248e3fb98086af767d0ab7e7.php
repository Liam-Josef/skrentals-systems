...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('browser_title'); ?>
        <title>Reschedule <?php echo e($booking->last); ?> <?php echo e($booking->first); ?> | <?php echo e($application->name); ?></title>
    <?php $__env->stopSection(); ?>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-11">
                                <form action="<?php echo e(route('reschedule.day', $booking)); ?>" id="bookStage1" method="post">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group mt-4">
                                                ...
                                                <input type="text" class="hidden" name="booking_id" value="<?php echo e($booking->id); ?>">
                                                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input type="text" class="hidden" name="orig_duration_id" value="<?php echo e($booking->duration_id); ?>">
                                                <input type="text" class="hidden" name="hour" value="<?php echo e($booking->hour); ?>">
                                                <input type="text" class="hidden" name="rental_time" value="00:00:00">
                                                <input type="text" class="hidden" name="end_time" value="<?php echo e($booking->end_time); ?>">
                                                <input type="text" class="hidden" name="activity_date_end" value="<?php echo e($booking->activity_date_end); ?>">
                                                <input type="text" class="hidden" name="quantity" value="<?php echo e($booking->quantity); ?>">
                                                <input type="text" class="hidden" name="cost_per" value="<?php echo e($booking->cost_per); ?>">
                                                <input type="text" class="hidden" name="additions" value="<?php echo e($booking->additions); ?>">
                                                <input type="text" class="hidden" name="fees" value="<?php echo e($booking->fees); ?>">
                                                <input type="text" class="hidden" name="total_cost" value="<?php echo e($booking->total_cost); ?>">
                                                <input type="text" class="hidden" name="total_paid" value="<?php echo e($booking->total_paid); ?>">
                                                <input type="text" class="hidden" name="total_owed" value="<?php echo e($booking->total_owed); ?>">
                                                <input type="text" class="hidden" name="internal_notes" value="<?php echo e($booking->internal_notes); ?>">
        ...
        <div class="card mt-4 mb-5 shadow">
            <div class="modal-footer">
                <div class="row width-100">
                    ...
                    <div class="col-sm-4">
                        <a href="<?php echo e(route('office.update_booking', $booking)); ?>" class="btn btn-outline-secondary btn-100">EDIT RENTAL</a>
                    </div>
                    <div class="col-sm-4">
...
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/office/reschedule.blade.php ENDPATH**/ ?>