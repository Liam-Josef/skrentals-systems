                        ...
                        <table class="table table-bordered" id="usersTable" width="100%" cellspacing="0">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="no-border-right pt-7"><a href="<?php echo e(route('user.profile.show', $user->id)); ?>" class="btn btn-primary-red width-100">View</a></td>
                                    ...
                                    <td class="pt-7 hidden-xs-table">
                                        <form action="<?php echo e(route('user.disable', $user->id)); ?>" method="post"
                                            ...
                                            <?php endif; ?>
                                              ...
                                              hidden
                                              <?php elseif($user->id == '3' or $user->id == '12'): ?>
                                              hidden
                                            <?php endif; ?>
                                        >
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/admin/users/index.blade.php ENDPATH**/ ?>