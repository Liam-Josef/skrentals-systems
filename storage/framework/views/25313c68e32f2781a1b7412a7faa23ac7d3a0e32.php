...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__env->startSection('page_title'); ?>
            <h1>Rental Profile
                ...
                <?php endif; ?> - <?php echo e($rental->first_name); ?> <?php echo e($rental->last_name); ?>
    ...
    <?php $__env->startSection('browser_title'); ?>
        <title><?php if($rental->invoice_number == ''): ?>
                <?php echo e($rental->booking_id); ?>

            <?php else: ?>
                #<?php echo e($rental->invoice_number); ?>

            <?php endif; ?> - <?php echo e($rental->first_name); ?> <?php echo e($rental->last_name); ?> | SK Watercraft Rentals</title>
    <?php $__env->stopSection(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <p class="item"><?php echo e($rental->phone); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Item -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="modal-footer pb-0">
                                    ...
                                    <a href="<?php echo e(route('office.customerProfile', $rental_customer->id)); ?>" class="btn btn-primary">
                                       View Customer
                                    </a>
                                </div>
                            </div>
    ...
    <?php $__env->startSection('sidebar'); ?>
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card my-4 shadow">
                ...
                <div class="card-body">
                    <?php echo e(\Illuminate\Support\Str::limit($post->body, '200', '...')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/office/rental-profile.blade.php ENDPATH**/ ?>