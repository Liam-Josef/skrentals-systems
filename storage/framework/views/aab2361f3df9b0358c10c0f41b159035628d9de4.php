    ...
    <div class="container-fluid">
        <div class="team-header">
            <a class="navbar-brand" href="<?php echo e(route('home.index')); ?>">
                <img src="<?php echo $__env->yieldContent('logo-square-1'); ?>" alt="SK Logo Light" />
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if(auth()->user()->userHasRole('Office')): ?>
                    <li class="nav-item smaller dropdown no-arrow mt-1 <?php echo e(Request::is('team/office*') ? 'active' : ''); ?>">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="officeDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('office.precheckin')); ?>">
                                Pre-Check In
                            </a>

                            <div class="dropdown-divider"></div>

                            <a class="dropdown-item" href="<?php echo e(route('office.rentalHistory')); ?>">
                                Rental History
                            </a>

                            <div class="dropdown-divider"></div>

                            <a class="dropdown-item" href="<?php echo e(route('office.customers')); ?>">
                                Customers
                            </a>

                            <div class="dropdown-divider"></div>

                            <a class="dropdown-item" href="<?php echo e(route('office.coc')); ?>">
                                Change of Condition
                            </a>
...
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/components/team/header/team-header.blade.php ENDPATH**/ ?>