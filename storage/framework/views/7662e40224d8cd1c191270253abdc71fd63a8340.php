<!--Add Customer Modal -->
<div class="modal fade" id="addCustomer" tabindex="-1" role="dialog" aria-labelledby="checkinModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 id="modal_rental_title" class="modal-title"><span>Add a Customer </span></h3>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?php echo e(route('customers.store')); ?>" enctype="multipart/form-data" class="addCustomer-form">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-4">
                                        <input type="hidden" class="form-control" name="license_front" value="License Not Yet Added...">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- /Add Customer Modal -->
<?php /**PATH C:\Users\liamj\dev-projects\sk-website\resources\views/components/admin/modals/add-customer.blade.php ENDPATH**/ ?>